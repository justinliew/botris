...
impl Board {
    pub fn new() -> Self {
        Board { delta: 0., cells: [Cell::new(); NUM_COLS*NUM_ROWS], user_row: 0, user_col: 2, bottom: 0 }
    }
	...
	fn swap_pieces_at_cursor(&mut self) {
		self.swap_cells(self.user_col,self.user_row,self.user_col+1,self.user_row);
